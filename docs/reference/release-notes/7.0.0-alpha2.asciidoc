...
Infra/Core::
* Do not open indices with broken index settings {pull}28574[#28574] (issues: {issue}26995[#26995], {issue}26998[#26998])

Infra/Scripting::
* Delete deprecated getValues from ScriptDocValues {pull}36183[#36183] (issue: {issue}22919[#22919])

Infra/Settings::
* Discontinue archiving broken cluster settings {pull}28253[#28253] (issue: {issue}28026[#28026])
...
Infra/Plugins::
* Drop name from all analysis component factories {pull}24976[#24976] (issue: {issue}24869[#24869])
...
* Add the ability to set the number of hits to track accurately {pull}35291[#35291] (issue: {issue}33028[#33028])
...
MULTIPLE AREA LABELS::
* SQL: Adds a set of geo objects for JDBC driver {pull}36415[#36415] (issues: {issue}29872[#29872], {issue}35767[#35767])
...
* Update aws java sdk to support ecs task roles {pull}25552[#25552] (issue: {issue}23039[#23039])
...
* [WIP]  Keep SnapshotInProgress State in Sync with Routing Table {pull}35637[#35637]
